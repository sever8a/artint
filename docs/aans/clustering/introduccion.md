...
!!! info "Organización de perfiles"

    Diferentes características sobre lo usuarios para organizarlos de una manera vinculante. Por ejemplo una red social, para clasificar los perfiles.

    Dividen el dataset inicial, sin etiquetar, en diferentes agrupaciones.
