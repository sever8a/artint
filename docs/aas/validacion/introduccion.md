...
!!! alert "Importancia de las métricas de evaluación"

    Según el problema que se esté tratando hay que considerar los valores más representativos, y las consecuencias en el contexto del problema.
